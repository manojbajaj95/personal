...
import { type ArticleWithMeta, getAllPosts } from '@/lib/articles'
...
function Article({ article }: { article: ArticleWithMeta }) {
  return (
    <Card as="article">
      ...
      <Card.Eyebrow as="time" dateTime={article.data.date} decorate>
...
export default async function Home() {
  let articles = (await getAllPosts()).slice(0, 4)
